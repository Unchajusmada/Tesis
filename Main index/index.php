        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav mr-auto py-0">
              <a href="index.html" class="nav-item nav-link pl-4 pl-md-2">Inicio</a>
              <a href="shop.html" class="nav-item nav-link pl-4 pl-md-2">Todas</a>
              <div class="nav-item dropdown d-block d-lg-none pl-4 pl-md-2">
                ...
                <div class="dropdown-menu rounded-0 m-0">
                  <a href="contact.html" class="dropdown-item">Autor</a>
                  <a href="shop.html" class="dropdown-item">Año</a>
                  <a href="shop.html" class="dropdown-item">Titulo</a>
                </div>
              </div>
              <div class="nav-item dropdown d-block d-lg-none pl-4 pl-md-2">
  ...
  <main>
    ...
    <div class="indice d-lg-block d-none">
      <aside id="menu">
        <h3>Organizar por:</h3>
        <ul>
          <li><a href="#autor" class="a-indice">Autor</a></li>
          <li><a href="#anio" class="a-indice">Año</a></li>
          <li><a href="#titulo" class="a-indice">Título</a></li>
          <li class="dropdown">
