...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2024 a las 18:18:10
...
(2, 'Carga desde teléfono', 'Luis Carlos ', 'Roa Bruzual', '2099', 'clbr@gmail.com', 'Ingenieria Electrica', 'Brandon Márquez', 'no', 'COMPROBANTE BANCARIO REGISTRO FUNDICION DEL CENTRO 1.pdf'),
(3, 'Constitucion de la Republica Bolivariana de Venezuela', 'Simón José Antonio de la Santísima Trinidad', 'Bolívar Ponte y Palacios Blanco', '1999', 'simonellibertador@patria.com', 'Ingenieria Civil', 'Andres Bello', 'si', 'constitucion-nacional-20191205135853.pdf'),
(4, 'Prueba tesis titulo largo normal promedio largo', 'Fulanito', 'Detal', '2000', 'luis@gmail.com', 'Ingenieria Aeronautica', 'Luis Luna', 'no', 'RifCarlosBruzual.pdf');
