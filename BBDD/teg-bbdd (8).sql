...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2024 a las 08:05:55
...
(15, 'FINAL - Sistema para Mejorar la Gestión Administrativa de Trabajo Especial de Grado en la UNEFA núcleo Maracay', 'Carlos Luis', 'Bruzual Roa', '2024', 'carlosluisbruzualroa@gmail.com', 'Ingenieria de Sistemas', 'Alexander Arroyo', 'si', 'Sistema para Mejorar la Gestion Administrativa de TEG en la UNEFA núcleo Maracay.pdf', 'Resumen TEG Carlos Bruzual.pdf'),
(20, 'Sistema para Mejorar la Gestión Administrativa de Trabajo Especial de Grado en la UNEFA núcleo Maracay', 'Carlos Luis', 'Bruzual Roa', '2024', 'carlosluisbruzualroa@gmail.com', 'Ingenieria de Sistemas', 'Alexander Arroyo', 'si', 'Sistema para Mejorar la Gestion Administrativa de TEG en la UNEFA núcleo Maracay.pdf', 'Resumen TEG Carlos Bruzual.pdf'),
...
--
ALTER TABLE `teg`
  MODIFY `ID_teg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
COMMIT;
